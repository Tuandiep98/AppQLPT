...
import 'floatingButtonMenu/fancy_fab.dart';

class HouseItemInforPage extends StatefulWidget
{
  HouseData house;
  HouseItemInforPage(this.house,{Key key}) : super(key: key);
  @override
  _HouseItemInforPageState createState() => _HouseItemInforPageState();
}

class _HouseItemInforPageState extends State<HouseItemInforPage>
{
  @override
        ...
        [
          SliverAppBar
            ...
            flexibleSpace: FlexibleSpaceBar
              (
              title: Text('Nhà trọ : ${widget.house.nameHouse}'),
              background: SizedBox.expand
                ...
                child: Stack
                  ...
                  children: <Widget>
                  [
                    Image.asset('assets/images/ic_house_appbar.png'),
                ...
                [
                  ...
                  Center
                    ...
                    child: Container
                      ...
                      child: Text
                        (
                          'Địa chỉ: ${widget.house.addressHouse}',
                        ...
                        child: Container
                          ...
                          child: ListTile
                            ...
                            trailing: CircleAvatar
                              ...
                              child: Text('${widget.house.numberHouse}'),
                            ),
                            title: Text('Số phòng', style: TextStyle()),
                        ...
                        child: Container
                          ...
                          child: ListTile
                            ...
                            trailing: CircleAvatar
                              (
                              backgroundColor: Colors.black,
                              child: Text('${widget.house.floorHouse}'),
                            ),
                            title: Text('Số tầng', style: TextStyle()),
                            subtitle: Text('subtitle', style: TextStyle()),
                          ),
                        ),
                      ),
                      ...
                      child: Container
                        ...
                        child: Container
                          ...
                          child: ListTile
                            ...
                            title: Text('Danh sách dịch vụ', style: TextStyle()),
                            subtitle: Text('subtitle', style: TextStyle()),
                          ),
                        ),
                      ),
