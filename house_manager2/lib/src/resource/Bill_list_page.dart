    ...
    return Scaffold
      (
        appBar: AppBar
          ...
          title: Text('Hóa đơn', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700)),
          // actions: <Widget>
          // [
          //   Container
          //   (
                    ...
                    child: Padding
                      ...
                      child: Row
                        ...
                        [
                          ...
                          Text('Tạo hóa đơn', style: TextStyle(color: Colors.white))
                        ],
                      ),
                    ),
                  ),
                  ...
                  [
                    ...
                    Container
                      ...
                      child: Material
                        ...
                        child: InkWell
                          (
                          onTap: null /*() => Navigator.of(context).push(MaterialPageRoute(builder: (_) => ItemReviewsPage()))*/,
                          child: Padding
                            (
                            ...
                            child: Column
                              ...
                              [
                                ...
                                Column
                                  ...
                                  children: <Widget>
                                  [
                                    Text('Hóa đơn example 1', style: TextStyle(color: Colors.blueAccent)),
                                    Row
                                      (
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: <Widget>
                                      [
                                        Text('Bên nhận: Partner 1', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                                ...
                                Row
                                  ...
                                  children: <Widget>
                                  [
                                    Text('Ngày lập:', style: TextStyle()),
                                    Padding
                                      (
                                      padding: EdgeInsets.symmetric(horizontal: 4.0),
                                      child: Text('17/11/2019', style: TextStyle(fontWeight: FontWeight.w700)),
                                    ),
                            ...
                            child: Column
                              ...
                              [
                                ...
                                Column
                                  ...
                                  children: <Widget>
                                  [
                                    Text('Hóa đơn example 2', style: TextStyle(color: Colors.white)),
                                    Row
                                      (
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: <Widget>
                                      [
                                        Text('Bên nhận: Partner 2', style: TextStyle(color: Colors.amber, fontWeight: FontWeight.w700, fontSize: 24.0)),
                                ...
                                Row
                                  ...
                                  children: <Widget>
                                  [
                                    Text('Ngày lập:', style: TextStyle(color: Colors.white)),
                                    Padding
                                      (
                                      padding: EdgeInsets.symmetric(horizontal: 4.0),
                                      child: Text('17/11/2019', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
                                    ),
                                    /*Text('(Đã duyệt)', style: TextStyle(color: Colors.white)),*/
                                    Padding
                                      (
                                      padding: EdgeInsets.symmetric(horizontal: 4.0),
                                      child: Material
                                        ...
                                        child: Padding
                                          (
                                          padding: EdgeInsets.all(4.0),
                                          child: Text('Chưa thanh toán', style: TextStyle(color: Colors.white)),
                                        ),
                                      ),
                                    ),
                                  ],
