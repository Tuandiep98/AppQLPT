    ...
    return Scaffold
      (
        appBar: AppBar
          ...
          title: Text('Hợp đồng', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700)),
          // actions: <Widget>
          // [
          //   Container
          //   (
                            ...
                            child: Column
                              ...
                              [
                                ...
                                Column
                                  ...
                                  children: <Widget>
                                  [
                                    Text('Hợp đồng example 1', style: TextStyle(color: Colors.blueAccent)),
                                    Row
                                      (
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: <Widget>
                                      [
                                        Text('Bên thuê: Partner 1', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                                    ...
                                    Padding
                                      ...
                                      child: Material
                                        ...
                                        child: Padding
                                          ...
                                          child: Text('Đã duyệt', style: TextStyle(color: Colors.white)),
                                        ),
                                      ),
                                    ),
                                  ],
                            ...
                            child: Column
                              ...
                              [
                                ...
                                Column
                                  ...
                                  children: <Widget>
                                  [
                                    Text('Hợp đồng example 2', style: TextStyle(color: Colors.white)),
                                    Row
                                      (
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: <Widget>
                                      [
                                        Text('Bên thuê: Partner 2', style: TextStyle(color: Colors.amber, fontWeight: FontWeight.w700, fontSize: 24.0)),
                                ...
                                Row
                                  ...
                                  [
                                    ...
                                    /*Text('(Đã hủy)', style: TextStyle(color: Colors.white)),*/
                                    Padding
                                      (
                                      padding: EdgeInsets.symmetric(horizontal: 4.0),
                                      child: Material
